...
const localTestDocumentAssets = defineDocumentAssets({
  collectingSeasonDeck: {
    ...
    src: "/local-test-documents/doc_demo_collecting_season.pptx",
    extension: "pptx",
  ...
  shelfPhotographyNotes: {
    ...
    src: "/local-test-documents/doc_demo_field_notes.docx",
    extension: "docx",
  ...
  careAndHandlingNotes: {
    ...
    src: "/local-test-documents/doc_demo_care_notes.pdf",
    extension: "pdf",
  ...
  collectionInventory: {
    ...
    src: "/local-test-documents/doc_demo_collection_inventory.csv",
    extension: "csv",
